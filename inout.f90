...
!     Telluric Research,                                             |
!     100 Barton St, Scone, 2337 Australia                           |
!                                                                    |
!     and                                                            |
!                                                                    |
...
! ======================================================================
! 
  LOGICAL FUNCTION ReadHeader(filenm,IVersion,iInit,RSTBoundFile)
    USE ModelParameters
    USE Support
...
&             ,Intvar,realvar,FilenameUser,MaxUser,iInit,RSTBoundFile)
        END IF
        CLOSE(UNIT=unitno)
      END IF
! 
...
! ======================================================================
! 
  SUBROUTINE rst2v78Header(Version,unitno,Intvar,realvar,FilenameUser,MaxUser  &
&                  ,iInit,RSTBoundFile)
      IMPLICIT NONE
! 
      INTEGER :: unitno,MaxUser,IntVar(*),iInit
      REAL(8) :: realvar(*),Version
      CHARACTER(*) :: FilenameUser(MaxUser),RSTBoundFile
